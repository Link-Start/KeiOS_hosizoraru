...
- `../README.md`: public project overview, latest stable tag, v1.7.2 highlights,
  install links, and quick feature summary.
- `CN.md`: Chinese public project overview, latest stable tag, v1.7.2 highlights,
  install links, and quick feature summary.
...
- `RELEASE_V1.7.2.md`: copy-ready GitHub Release notes and final v1.7.2 release gates.
