...
internal const val GITHUB_APK_STREAM_BUFFER_SIZE = 1024 * 1024

private const val ANDROID_MANIFEST_ENTRY = "AndroidManifest.xml"

internal fun selectGitHubInstallApkEntry(zipFile: ZipFile): ZipEntry? =
    zipFile
        .entries()
        .asSequence()
...
internal fun ZipFile.isGitHubDirectApkArchive(): Boolean = getEntry(ANDROID_MANIFEST_ENTRY) != null

internal fun String.toGitHubApkSessionName(): String {
...
internal fun createGitHubTempApkFile(
    context: Context,
    assetName: String,
): File = createGitHubTempInstallFile(context, assetName, ".apk")

internal fun createGitHubTempInstallFile(
    context: Context,
    assetName: String,
    suffix: String,
): File {
