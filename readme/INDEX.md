...
- `../README.md`: public project overview, release channel, v1.16.0 highlights,
  install links, and quick feature summary.
- `CN.md`: Chinese public project overview, release channel, v1.16.0 highlights,
  install links, and quick feature summary.
...
- `RELEASE_V1.16.0.md`: copy-ready bilingual GitHub Release notes for v1.16.0.
