...
internal fun decodeBaCalendarEntries(
    raw: String,
...
internal fun decodeBaPoolEntries(
    raw: String,
    nowMs: Long = System.currentTimeMillis(),
): List<BaPoolEntry> {
    if (raw.isBlank()) return emptyList()
    ...
    for (i in 0 until arr.length()) {
        ...
        parsed +=
            BaPoolEntry(
                ...
                studentGuideUrl =
                    canonicalBaPoolStudentGuideUrlOrBlank(
