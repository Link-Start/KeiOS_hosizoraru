        ...
        SettingsSearchTarget(
            ...
            tokens =
                settingsTokens(
                    ...
                    stringResource(R.string.settings_launcher_icon_design_title),
                    stringResource(R.string.settings_launcher_icon_design_apple),
                    stringResource(R.string.settings_launcher_icon_design_android),
        ...
        SettingsSearchTarget(
            ...
            tokens =
                settingsTokens(
                    ...
                    stringResource(R.string.settings_liquid_toast_title),
                    stringResource(R.string.settings_liquid_sheet_title),
                    stringResource(R.string.settings_liquid_dialog_title),
        ...
        SettingsSearchTarget(
            ...
            tokens =
                settingsTokens(
                    ...
                    stringResource(R.string.settings_log_level_title),
                    stringResource(R.string.settings_log_feedback_action),
                ),
        ),
    )
