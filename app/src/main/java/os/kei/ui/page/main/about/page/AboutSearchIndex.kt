        ...
        AboutSearchTarget(
            ...
            tokens =
                aboutTokens(
                    ...
                    context.getString(R.string.about_release_row_releases),
                    context.getString(R.string.about_release_row_fdroid),
                    context.getString(R.string.about_release_row_large_screens),
                    context.getString(R.string.about_release_row_catalog),
                    context.getString(R.string.about_release_row_mcp_security),
                    ...
                    context.getString(R.string.about_release_value_releases),
                    context.getString(R.string.about_release_value_fdroid),
                    context.getString(R.string.about_release_value_large_screens),
                    context.getString(R.string.about_release_value_catalog),
                    context.getString(R.string.about_release_value_mcp_security),
