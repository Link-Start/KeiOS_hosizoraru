...
internal fun rememberHomePageContentTextBundle(): HomePageContentTextBundle =
    HomePageContentTextBundle(
        ...
        webDavConfigured = stringResource(R.string.home_webdav_status_configured),
        ...
        statAutoSync = stringResource(R.string.home_stat_auto_sync),
