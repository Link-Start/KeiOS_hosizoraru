...
internal fun parseTrackedItem(obj: JSONObject): GitHubTrackedApp? {
...
internal fun parseTrackedSourceMode(obj: JSONObject): GitHubTrackedSourceMode {
    val settings = obj.optJSONObject("settings")
    val source = obj.optJSONObject("source")
    return when {
...
internal fun parseTrackedLocalAppType(obj: JSONObject): GitHubTrackedLocalAppType {
    val settings = obj.optJSONObject("settings")
...
internal fun parsePreciseApkVersionMode(obj: JSONObject): GitHubTrackedPreciseApkVersionMode {
    val settings = obj.optJSONObject("settings")
...
internal fun parseActionsUpdateIntervalMode(obj: JSONObject): GitHubTrackedActionsUpdateIntervalMode {
    val settings = obj.optJSONObject("settings")
    return when {
...
internal fun trackedItemToJson(item: GitHubTrackedApp): JSONObject {
...
internal fun GitHubTrackedItemsOptionCounts.toJson(): JSONObject {
    return JSONObject()
...
internal fun GitHubTrackedItemsSourceCounts.toJson(): JSONObject {
    return JSONObject()
        .put("githubRepository", githubRepositoryCount)
        .put("directApk", directApkCount)
}

internal fun parseRemoteApkVersionInfo(obj: JSONObject?): GitHubRemoteApkVersionInfo? {
    obj ?: return null
...
internal fun parseDirectApkRemoteHealth(raw: String): GitHubDirectApkRemoteHealth {
...
internal fun remoteApkVersionInfoToJson(info: GitHubRemoteApkVersionInfo?): JSONObject? {
    info ?: return null
    return JSONObject()
