...
internal fun rememberBuiltInActivityShortcutCards(
    ...
    return remember(
        ...
        buildBuiltInActivityShortcutCards(
            labels =
                BuiltInActivityShortcutLabels(
                    androidSettingsAppName = androidSettingsAppName,
                    crossDeviceAppName = crossDeviceAppName,
                    googleSettingsTitle = googleSettingsTitle,
                    googleSettingsSubtitle = googleSettingsSubtitle,
                    googleSettingsAppName = googleSettingsAppName,
                    googleSettingsPackage = googleSettingsPackage,
                    googleSettingsClass = googleSettingsClass,
                    extraDimTitle = extraDimTitle,
                    extraDimSubtitle = extraDimSubtitle,
                    appBatteryTitle = appBatteryTitle,
                    appBatterySubtitle = appBatterySubtitle,
                    notificationTitle = notificationTitle,
                    notificationSubtitle = notificationSubtitle,
                    appManagementTitle = appManagementTitle,
                    appManagementSubtitle = appManagementSubtitle,
                    appMemoryTitle = appMemoryTitle,
                    appMemorySubtitle = appMemorySubtitle,
                    languageSettingsTitle = languageSettingsTitle,
                    languageSettingsSubtitle = languageSettingsSubtitle,
                    fullScreenDisplayTitle = fullScreenDisplayTitle,
                    fullScreenDisplaySubtitle = fullScreenDisplaySubtitle,
                    crossDeviceTitle = crossDeviceTitle,
                    crossDeviceSubtitle = crossDeviceSubtitle,
                ),
...
internal fun buildBuiltInActivityShortcutCards(
    context: Context,
    defaults: OsGoogleSystemServiceConfig,
    defaultIntentFlags: String,
): List<OsActivityShortcutCard> =
    buildBuiltInActivityShortcutCards(
        labels =
            BuiltInActivityShortcutLabels(
                androidSettingsAppName = context.getString(R.string.os_activity_builtin_android_settings_app_name),
                crossDeviceAppName = context.getString(R.string.os_activity_builtin_cross_device_app_name),
                googleSettingsTitle = context.getString(R.string.os_activity_builtin_google_settings_title),
                googleSettingsSubtitle = context.getString(R.string.os_activity_builtin_google_settings_subtitle),
                googleSettingsAppName = context.getString(R.string.os_activity_builtin_google_settings_app_name),
                googleSettingsPackage = context.getString(R.string.os_activity_builtin_google_settings_package),
                googleSettingsClass = context.getString(R.string.os_activity_builtin_google_settings_class),
                extraDimTitle = context.getString(R.string.os_activity_builtin_extra_dim_title),
                extraDimSubtitle = context.getString(R.string.os_activity_builtin_extra_dim_subtitle),
                appBatteryTitle = context.getString(R.string.os_activity_builtin_app_battery_usage_title),
                appBatterySubtitle = context.getString(R.string.os_activity_builtin_app_battery_usage_subtitle),
                notificationTitle = context.getString(R.string.os_activity_builtin_notification_settings_title),
                notificationSubtitle = context.getString(R.string.os_activity_builtin_notification_settings_subtitle),
                appManagementTitle = context.getString(R.string.os_activity_builtin_app_management_title),
                appManagementSubtitle = context.getString(R.string.os_activity_builtin_app_management_subtitle),
                appMemoryTitle = context.getString(R.string.os_activity_builtin_app_memory_usage_title),
                appMemorySubtitle = context.getString(R.string.os_activity_builtin_app_memory_usage_subtitle),
                languageSettingsTitle = context.getString(R.string.os_activity_builtin_language_settings_title),
                languageSettingsSubtitle = context.getString(R.string.os_activity_builtin_language_settings_subtitle),
                fullScreenDisplayTitle = context.getString(R.string.os_activity_builtin_fullscreen_display_title),
                fullScreenDisplaySubtitle = context.getString(R.string.os_activity_builtin_fullscreen_display_subtitle),
                crossDeviceTitle = context.getString(R.string.os_activity_builtin_cross_device_services_title),
                crossDeviceSubtitle = context.getString(R.string.os_activity_builtin_cross_device_services_subtitle),
            ),
        defaultIntentFlags = defaultIntentFlags,
        defaults = defaults,
    )

private fun buildBuiltInActivityShortcutCards(
    labels: BuiltInActivityShortcutLabels,
    defaultIntentFlags: String,
    defaults: OsGoogleSystemServiceConfig,
): List<OsActivityShortcutCard> =
    listOf(
        builtInActivityShortcutCard(
            ...
            title = labels.googleSettingsTitle,
            subtitle = labels.googleSettingsSubtitle,
            appName = labels.googleSettingsAppName,
            packageName = labels.googleSettingsPackage,
            className = labels.googleSettingsClass,
        ...
        builtInActivityShortcutCard(
            ...
            title = labels.extraDimTitle,
            subtitle = labels.extraDimSubtitle,
            appName = labels.androidSettingsAppName,
        ...
        builtInActivityShortcutCard(
            ...
            title = labels.appBatteryTitle,
            subtitle = labels.appBatterySubtitle,
            appName = labels.androidSettingsAppName,
            packageName = SETTINGS_PACKAGE,
        ...
        builtInActivityShortcutCard(
            ...
            subtitle = labels.notificationSubtitle,
            appName = labels.androidSettingsAppName,
            packageName = SETTINGS_PACKAGE,
        ...
        builtInActivityShortcutCard(
            ...
            title = labels.appManagementTitle,
            subtitle = labels.appManagementSubtitle,
            appName = labels.androidSettingsAppName,
            packageName = SETTINGS_PACKAGE,
        ...
        builtInActivityShortcutCard(
            ...
            title = labels.appMemoryTitle,
            subtitle = labels.appMemorySubtitle,
            appName = labels.androidSettingsAppName,
            packageName = SETTINGS_PACKAGE,
        ...
        builtInActivityShortcutCard(
            ...
            title = labels.languageSettingsTitle,
            subtitle = labels.languageSettingsSubtitle,
            appName = labels.androidSettingsAppName,
            packageName = SETTINGS_PACKAGE,
        ...
        builtInActivityShortcutCard(
            ...
            title = labels.fullScreenDisplayTitle,
            subtitle = labels.fullScreenDisplaySubtitle,
            appName = labels.androidSettingsAppName,
            packageName = SETTINGS_PACKAGE,
        ...
        builtInActivityShortcutCard(
            ...
            title = labels.crossDeviceTitle,
            subtitle = labels.crossDeviceSubtitle,
            appName = labels.crossDeviceAppName,
...
private data class BuiltInActivityShortcutLabels(
    val androidSettingsAppName: String,
    val crossDeviceAppName: String,
    val googleSettingsTitle: String,
    val googleSettingsSubtitle: String,
    val googleSettingsAppName: String,
    val googleSettingsPackage: String,
    val googleSettingsClass: String,
    val extraDimTitle: String,
    val extraDimSubtitle: String,
    val appBatteryTitle: String,
    val appBatterySubtitle: String,
    val notificationTitle: String,
    val notificationSubtitle: String,
    val appManagementTitle: String,
    val appManagementSubtitle: String,
    val appMemoryTitle: String,
    val appMemorySubtitle: String,
    val languageSettingsTitle: String,
    val languageSettingsSubtitle: String,
    val fullScreenDisplayTitle: String,
    val fullScreenDisplaySubtitle: String,
    val crossDeviceTitle: String,
    val crossDeviceSubtitle: String,
)
