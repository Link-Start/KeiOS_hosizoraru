...
- GitHub 托管安装继续收口，Release APK 与 Actions artifacts 的安装、通知 / 超级岛路由更稳定，减少安装确认时的打断感。
- GitHub 追踪新增单项目“检查更新”间隔，可让重要项目或高频项目独立于全局刷新节奏。
- Actions artifacts card 的安装与分享按钮更紧凑，列表信息更容易扫读。
- 设置页结构更清晰：通知相关项迁移到权限板块，外观与效果控制拆分整理。
- GitHub 后端、core prefs / system 边界、依赖版本和发布测试继续整理，提升 1.7.x 日常稳定性。
...
- 当前稳定标签：[v1.7.2](https://github.com/hosizoraru/KeiOS/releases/tag/v1.7.2)。
...
- [文档索引](INDEX.md)
- [Release Notes v1.7.2](RELEASE_V1.7.2.md)
