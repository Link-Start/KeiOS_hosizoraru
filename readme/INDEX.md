...
- `../README.md`: public project overview, latest stable tag, v1.7.1 highlights,
  install links, and quick feature summary.
- `CN.md`: Chinese public project overview, latest stable tag, v1.7.1 highlights,
  install links, and quick feature summary.
...
- `RELEASE_V1.7.1.md`: copy-ready GitHub Release notes and final v1.7.1 release gates.
