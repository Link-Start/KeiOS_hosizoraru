...
- Actions artifacts card 去掉 sha256 详情，列表更清爽，用户扫读 artifact 更轻松。
- 下载控件直接显示文件大小，动作含义交给 icon，减少重复文字。
- 支持托管安装的 APK artifact 会同时提供安装和下载两个动作，安装继续走 KeiOS 确认链路，下载走外部 / 系统下载链路。
- Actions artifact 下载按钮保持常显，适配 GitHub Web 登录或 Token 下载等场景。
- Artifact 详情 sheet 同步精简元数据，保持列表与详情体验一致。
...
- 当前稳定标签：[v1.7.3](https://github.com/hosizoraru/KeiOS/releases/tag/v1.7.3)。
...
- [文档索引](INDEX.md)
- [Release Notes v1.7.3](RELEASE_V1.7.3.md)
