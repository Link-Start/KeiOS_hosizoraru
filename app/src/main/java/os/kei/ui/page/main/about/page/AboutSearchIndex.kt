    ...
    return listOf(
        ...
        AboutSearchTarget(
            ...
            tokens = aboutTokens(
                ...
                stringResource(R.string.debug_v2_liquid_sample_title),
                stringResource(R.string.debug_v2_liquid_sample_subtitle),
                stringResource(R.string.debug_v2_liquid_sample_entry_note),
                stringResource(R.string.debug_v2_liquid_sample_row_components_value),
                stringResource(R.string.debug_v2_liquid_search_token_backdrop_v2),
                stringResource(R.string.debug_v2_liquid_search_token_liquid_glass),
                stringResource(R.string.debug_v2_liquid_search_token_controls),
                stringResource(R.string.debug_v2_liquid_search_token_pager),
                stringResource(R.string.debug_v2_liquid_search_token_performance),
