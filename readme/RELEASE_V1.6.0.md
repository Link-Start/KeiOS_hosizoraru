...
- Release hardening covers bottom-bar visibility recovery, benchmark package startup, Gradle
...
- 发布前收口覆盖底栏可见性恢复、Benchmark 包启动、Gradle configuration cache、Ktor 3.5.0、范围更广的
  Baseline Profiles、单元测试、R8 keep 规则和 Release / Benchmark mapping 审查。
