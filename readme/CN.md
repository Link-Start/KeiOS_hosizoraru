...
- GitHub Actions artifacts card 去掉 sha256 详情，下载控件显示文件大小，安装与下载拆成两个独立动作。
- 下载按钮在 nightly.link 与 GitHub API Token 两种模式下保持常驻，公开仓库与 Token 下载链路体验更一致。
- Actions APK artifact 的托管安装与分享导入链路继续收口，安装确认、receiver 路由、通知清理与超级岛动作更稳定。
- GitHub 追踪新增单项目检查更新间隔，可跟随全局，也可单独设置 1、3、6、12 小时。
- 设置分区、图标偏好默认值、GitHub feature module 边界、依赖刷新与发布检测一起整理。
...
- 当前稳定标签：[v1.8.0](https://github.com/hosizoraru/KeiOS/releases/tag/v1.8.0)。
...
- [文档索引](INDEX.md)
- [Release Notes v1.8.0](RELEASE_V1.8.0.md)
