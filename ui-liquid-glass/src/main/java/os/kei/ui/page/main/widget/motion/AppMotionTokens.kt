...
fun resolvedMotionDuration(durationMillis: Int, animationsEnabled: Boolean): Int {
    return if (animationsEnabled) durationMillis else AppMotionTokens.disabledDurationMs
}

@Composable
fun appMotionFloatState(
    targetValue: Float,
    label: String
): State<Float> {
...
fun motionDisabledEasingOrDefault(
