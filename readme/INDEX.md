...
- `../README.md`: public project overview, latest stable tag, v1.8.0 highlights,
  install links, and quick feature summary.
- `CN.md`: Chinese public project overview, latest stable tag, v1.8.0 highlights,
  install links, and quick feature summary.
...
- `RELEASE_V1.8.0.md`: copy-ready GitHub Release notes and final v1.8.0 release gates.
