...
internal val profileSectionHeaderKeys =
    setOf("介绍", "学生信息", "信息")
        .map(::normalizeProfileFieldKey)
        .toSet()
internal val profileCapsuleFieldKeys =
    setOf(
        "角色名称",
        "年龄",
        "生日",
...
internal val profileLongTextFieldKeys =
    setOf(
        "全名",
        "个人简介",
        "简介",
...
internal val profileFullWidthInfoRowKeys =
    setOf(
        "个人简介",
        "简介",
        "介绍",
