...
- Liquid Glass sheet 继续清理关闭链路，保存、编辑和返回手势后的 overlay 状态更稳定。
- OS 工具新增状态栏通知图标数量、隐藏手势提示线等内置 shell card，并修正全面屏设置快捷入口信息。
- Shell 与 MCP 的完成、复制、清空、刷新等轻提示改为只使用低打扰 Liquid Glass Toast；错误、权限、失败提示继续保留。
- 设置新增“减少轻提示打扰”开关，开启后可静默运行完成、复制完成、清空完成等低优先级提示。
- Liquid Glass 组件层继续精修 dialog、switch、checkbox、progress bar 和 toast 的显示细节。
...
- 当前稳定标签：[v1.7.1](https://github.com/hosizoraru/KeiOS/releases/tag/v1.7.1)。
...
- [文档索引](INDEX.md)
- [Release Notes v1.7.1](RELEASE_V1.7.1.md)
