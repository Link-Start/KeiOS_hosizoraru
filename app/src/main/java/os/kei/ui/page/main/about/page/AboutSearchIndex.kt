        ...
        AboutSearchTarget(
            ...
            tokens =
                aboutTokens(
                    ...
                    context.getString(R.string.about_release_row_tracking),
                    context.getString(R.string.about_release_row_network),
                    context.getString(R.string.about_release_row_histories),
                    context.getString(R.string.about_release_row_glass),
                    context.getString(R.string.about_release_row_gestures),
                    context.getString(R.string.about_release_row_security),
                    ...
                    context.getString(R.string.about_release_value_tracking),
                    context.getString(R.string.about_release_value_network),
                    context.getString(R.string.about_release_value_histories),
                    context.getString(R.string.about_release_value_glass),
                    context.getString(R.string.about_release_value_gestures),
                    context.getString(R.string.about_release_value_security),
