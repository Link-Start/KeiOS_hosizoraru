...
internal object McpToolCatalog {
    ...
    private val zhDescriptions = mapOf(
        ...
        "keios.github.tracks.list" to "列出已追踪仓库。参数：repoFilter、limit。",
        "keios.github.tracks.export" to "将已追踪仓库导出为 JSON。参数：repoFilter。",
        "keios.github.tracks.import" to "预览或导入已追踪仓库 JSON。参数：json、apply。",
        "keios.github.tracks.check" to "联网检查已追踪仓库更新。参数：repoFilter、onlyUpdates、limit。",
        "keios.github.tracks.summary" to "汇总缓存或联网追踪状态。参数：mode=cache|network、repoFilter。",
    ...
    private val jaDescriptions = mapOf(
        ...
        "keios.github.tracks.list" to "追跡中リポジトリを一覧します。引数: repoFilter、limit。",
        "keios.github.tracks.export" to "追跡中リポジトリを JSON としてエクスポートします。引数: repoFilter。",
        "keios.github.tracks.import" to "追跡中リポジトリ JSON をプレビューまたはインポートします。引数: json、apply。",
        "keios.github.tracks.check" to "追跡中リポジトリの更新をオンライン確認します。引数: repoFilter、onlyUpdates、limit。",
        "keios.github.tracks.summary" to "キャッシュまたはオンラインの追跡状態を要約します。引数: mode=cache|network、repoFilter。",
