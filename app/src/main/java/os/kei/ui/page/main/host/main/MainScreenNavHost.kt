    ...
    val entryProvider = entryProvider<NavKey> {
        ...
        entry<KeiosRoute.Settings> {
            SettingsPage(
                ...
                firebaseBasicStatsEnabled = prefsState.firebaseBasicStatsEnabled,
                onFirebaseBasicStatsChanged = prefsState::updateFirebaseBasicStatsEnabled,
                firebaseErrorLogsEnabled = prefsState.firebaseErrorLogsEnabled,
                onFirebaseErrorLogsChanged = prefsState::updateFirebaseErrorLogsEnabled,
                shizukuStatus = pagerCoordinator.shizukuStatus,
