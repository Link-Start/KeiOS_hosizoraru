...
internal object McpToolCatalog {
    ...
    private val enDescriptions = mapOf(
        ...
        "keios.github.tracks.list" to "List tracked GitHub repository or direct APK entries. Args: repoFilter, sourceMode=github_repository|direct_apk, limit.",
        "keios.github.tracks.export" to "Export tracked GitHub repository or direct APK entries as JSON. Args: repoFilter, sourceMode.",
        "keios.github.tracks.import" to "Preview or import tracked GitHub repository and direct APK JSON. Args: json, apply.",
        "keios.github.tracks.check" to "Check tracked GitHub repository or direct APK entries online. Args: repoFilter, sourceMode, onlyUpdates, limit.",
        "keios.github.tracks.summary" to "Summarize cached or online tracking state. Args: mode=cache|network, repoFilter, sourceMode.",
    ...
    private val zhDescriptions = mapOf(
        ...
        "keios.github.tracks.list" to "列出已追踪 GitHub 仓库或直链 APK 项。参数：repoFilter、sourceMode=github_repository|direct_apk、limit。",
        "keios.github.tracks.export" to "将已追踪 GitHub 仓库或直链 APK 项导出为 JSON。参数：repoFilter、sourceMode。",
        "keios.github.tracks.import" to "预览或导入已追踪 GitHub 仓库与直链 APK JSON。参数：json、apply。",
        "keios.github.tracks.check" to "联网检查已追踪 GitHub 仓库或直链 APK 项更新。参数：repoFilter、sourceMode、onlyUpdates、limit。",
        "keios.github.tracks.summary" to "汇总缓存或联网追踪状态。参数：mode=cache|network、repoFilter、sourceMode。",
    ...
    private val jaDescriptions = mapOf(
        ...
        "keios.github.tracks.list" to "追跡中の GitHub リポジトリまたは直接 APK 項目を一覧します。引数: repoFilter、sourceMode、limit。",
        "keios.github.tracks.export" to "追跡中の GitHub リポジトリまたは直接 APK 項目を JSON としてエクスポートします。引数: repoFilter、sourceMode。",
        "keios.github.tracks.import" to "追跡中の GitHub リポジトリと直接 APK JSON をプレビューまたはインポートします。引数: json、apply。",
        "keios.github.tracks.check" to "追跡中の GitHub リポジトリまたは直接 APK 項目の更新をオンライン確認します。引数: repoFilter、sourceMode、onlyUpdates、limit。",
        "keios.github.tracks.summary" to "キャッシュまたはオンラインの追跡状態を要約します。引数: mode=cache|network、repoFilter、sourceMode。",
