...
internal data class OsPageOverlayState(
    ...
    val onActivityVisibilityQueryChange: (String) -> Unit,
    ...
    val onShellCardVisibilityQueryChange: (String) -> Unit,
...
internal fun rememberOsPageOverlayState(
    ...
    return remember(
        ...
        activityVisibilityQuery,
        onActivityVisibilityQueryChange,
        showShellCardVisibilityManager,
        onShowShellCardVisibilityManagerChange,
        shellCardVisibilityQuery,
        onShellCardVisibilityQueryChange,
        ...
        OsPageOverlayState(
            ...
            activityVisibilityQuery = activityVisibilityQuery,
            onActivityVisibilityQueryChange = onActivityVisibilityQueryChange,
            ...
            shellCardVisibilityQuery = shellCardVisibilityQuery,
            onShellCardVisibilityQueryChange = onShellCardVisibilityQueryChange,
