...
- App 图标切换为新的 Apple Designs 默认图标，同时保留 Android Designs 旧版图标供用户切换。
- 发布前完成底栏可见性恢复、benchmark 包启动、Gradle configuration cache、单元测试、R8 keep 规则和 release/benchmark mapping 审查。
