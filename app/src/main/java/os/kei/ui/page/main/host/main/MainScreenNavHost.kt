    ...
    val entryProvider = entryProvider<NavKey> {
        entry<KeiosRoute.Main> {
            MainPagerLayout(
                ...
                mainPagerMiuixModeEnabled = pagerCoordinator.mainPagerMiuixModeEnabled,
        ...
        entry<KeiosRoute.Settings> {
            SettingsPage(
                ...
                mainPagerMiuixModeEnabled = prefsState.mainPagerMiuixModeEnabled,
                onMainPagerMiuixModeChanged = prefsState::updateMainPagerMiuixModeEnabled,
